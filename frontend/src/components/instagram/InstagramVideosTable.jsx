        ...
        <table className="w-full">
          <thead>
            <tr className="text-left text-gray-400 text-sm font-medium border-b border-gray-700 pb-6">
              ...
              <th className="pb-6 pr-8 text-center">Salvos</th>
                ...
                <td className="py-6 pr-8">
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      ...
                      {post.type === "Story" && (
                        <span className="absolute bottom-1 right-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs px-1.5 py-0.5 rounded">
                          STORY
                        </span>
                      )}
                    </div>
                    <div className="max-w-xs">
                      <p className="text-white font-medium text-sm lg:text-base leading-tight line-clamp-2 group-hover:text-purple-300 transition-colors">
                        {post.title}
                      </p>
              ...
              >
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    {post.type === "Story" && (
                      <span className="absolute -top-1 -right-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-[10px] px-1.5 py-0.5 rounded-full font-bold">
                        S
                      </span>
                    )}
                    {post.duration !== "-" && (
              ...
              {isExpanded && (
                <div className="px-3 pb-3 pt-1 border-t border-gray-700/50 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-4 gap-3 mb-3">
                    ...
                    <div className="text-center">
                      <div className="flex flex-col items-center p-2 bg-gray-900/50 rounded-lg">
                        <Bookmark className="w-4 h-4 text-gray-400 mb-1" />
                        <span className="text-xs font-bold text-white">
                          {formatNumber(post.saves)}
                        </span>
                        <span className="text-[10px] text-gray-400 mt-0.5">
